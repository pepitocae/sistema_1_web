     ...
     <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <input type="text" class="form-control" id="numero_compra" name="numero_compra" value="<?php $codigo=$compra->numero_compra();?>"  readonly>
               ...
               <div class="form-group">
                  <label for="" class="col-lg-3 control-label">R.F.C.</label>

                  <div class="col-lg-9">
                    <input type="text" class="form-control" id="cedula" name="cedula" placeholder="R.F.C." required pattern="[0-9]{0,15}" readonly>
                  </div>
              </div>
