   ...
   <div class="modal fade" id="modalCliente">
           ...
           <!--antes tenia un class="modal-content" y lo cambié por bg-warning para que tuviera fondo blanco, deberia haber sido un color naranja claro pero me salió un color blanco de casualidad--> 
            <div class="bg-warning">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-user-circle" aria-hidden="true"></i> Listado de Clientes</h4>
              </div>
        ...
        <div class="table-responsive">
             ...
             <table id="lista_clientes_data" class="table table-bordered table-striped">
                ...
                <thead>
                  <tr>
                    <th class="all" width="20%">R.F.C.</th>
                    <th class="all" width="40%">Nombres</th>
                    <th class="not-mobile desktop tablet-p tablet-l" width="10%">Apellidos</th>
