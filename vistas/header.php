...
<head>
  ...
  <title> Sistema Punto de Venta MT Technology | www.mttechnology.mtcorp.mx</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>A</b>MT T.</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>MT Technology</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Administrador desde Enero 2019</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!--<li class="user-body">
